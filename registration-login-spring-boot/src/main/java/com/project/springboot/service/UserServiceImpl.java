...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		...
		User user = new User(registrationDto.getFirstName(), 
				...
				passwordEncoder.encode(registrationDto.getPassword()),registrationDto.getGender(), registrationDto.getMobileNumber(),registrationDto.getDob(),Arrays.asList(new Role("ROLE_USER")));
